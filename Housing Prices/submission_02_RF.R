...
# Prediction with basic random forest model


set.seed(2531)

p1.rf <- randomForest(SalePrice ~ ., data = t2, mtry = 3, importance = TRUE, na.action = na.omit)

p1.rf

round(importance(p1.rf), 2)

p1 <- predict(p1.rf, newdata = v2)
...
write_csv(df_tt, "submission_02.csv")

# Submission_02: improved score by 299 places to 1662. Score = 0.16304
